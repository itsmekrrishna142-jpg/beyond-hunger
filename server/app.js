...
app.listen(PORT, () => {
  ...
  console.log(`🔗 Health check: https://beyond-hunger.onrender.com/api/health`);
  console.log(`🔗 Database test: https://beyond-hunger.onrender.com/api/test-db`);
